...
<style lang="less">
	...
	.uni-steps-item:last-child .uni-steps-item-title-container:last-child {
		bottom: -38px;
		right:-40px;
		width: 200upx;
	...
	.uni-steps-item.uni-steps-finish:first-child .uni-steps-item-title-container:nth-child(2){
		position: absolute;
		left: -50px;
	}
	.uni-steps-item.uni-steps-finish .uni-steps-item-title-container .uni-steps-item-desc  {
		color:#aeb1b5;
	}
	...
	.uni-steps-item:last-child .uni-steps-item-title-container:nth-child(0) {
		bottom: -38px;
		right:-40px;
		width: 200upx;
		text-align: center !important;
